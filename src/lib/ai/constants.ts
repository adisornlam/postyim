...
/** Signals that content was machine-written — blocked in public copy and meta. */
export const AI_AUTHORSHIP_PHRASES = [
  "ai-assisted",
  "ai assisted",
...
export function containsAiAuthorshipSignals(text: string): boolean {
  const normalized = text.toLowerCase();
  return AI_AUTHORSHIP_PHRASES.some((phrase) => normalized.includes(phrase));
}
...
export function stripProhibitedPhrases(content: string): string {
  ...
  for (const phrase of [...PROHIBITED_PHRASES, ...AI_AUTHORSHIP_PHRASES]) {
